					...
					<div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
						...
						<div className="lg:w-1/2 space-y-8 text-center lg:text-left">
							<div>
								...
								<h2 className="text-4xl lg:text-6xl text-white/80 font-display font-semibold leading-tight mt-6 tracking-tight">
									Khởi tạo <br />
							...
							<p className="text-stone text-base lg:text-lg leading-relaxed max-w-md mx-auto lg:mx-0 font-light">
								Chúng tôi luôn sẵn sàng lắng nghe và tư vấn giải pháp tối ưu
								nhất cho sự kiện của bạn qua các kênh liên lạc trực tiếp.
							</p>
						...
						<div className="lg:w-1/2 w-full grid grid-cols-1 gap-6">
							...
							>
								...
								<div className="space-y-3">
									<span className="text-stone text-[10px] uppercase tracking-[0.4em] font-medium">
										Hotline hỗ trợ 24/7
									</span>
									<h3 className="text-3xl lg:text-5xl font-display font-medium text-white group-hover:text-gold transition-colors">
										{hotline}
									</h3>
									<p className="text-stone/60 text-sm font-light italic">
										Chạm để thực hiện cuộc gọi ngay
									</p>
								</div>
							</a>
							...
							>
								...
								<div className="space-y-3">
									...
									<p className="text-stone/60 text-sm font-light italic">
										Gửi tin nhắn nhận báo giá chi tiết
									</p>
								</div>
							</a>
						</div>
