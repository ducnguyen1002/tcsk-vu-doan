    ...
    <section className="py-24 lg:py-48 bg-cream border-y border-gold-light/20 overflow-hidden">
      <div className="container-custom">
        <div className="flex flex-col items-center text-center">
          <SectionLabel className="justify-center">Cảm nhận khách hàng</SectionLabel>
          ...
          <div className="relative max-w-4xl pt-16">
            ...
            <div ref={quoteRef} className="relative z-10 px-8">
              <p className="text-3xl lg:text-4xl font-display italic font-light leading-relaxed mb-12">
                &ldquo;{TESTIMONIALS[current].quote}&rdquo;
              </p>
              
              <div className="flex flex-col items-center">
                <span className="text-ink font-medium uppercase tracking-widest text-sm mb-1 uppercase tracking-widest">— {TESTIMONIALS[current].name}</span>
                <span className="text-stone text-[11px] uppercase tracking-[0.2em]">{TESTIMONIALS[current].role}</span>
              </div>
            </div>
